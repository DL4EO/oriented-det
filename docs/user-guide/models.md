...
- **`OrientedRCNN`** — Two-stage: horizontal RPN with midpoint-offset proposals + oriented ROI head
- **`RotatedFasterRCNN`** — Two-stage: oriented RPN + oriented ROI head
- **`RotatedRetinaNet`** — Single-stage oriented RetinaNet with focal loss
