...
| Score floor | `score_thr=0.05` | `production.score_threshold: 0.05` | no |
...
`hrsc2016_le90_3x.json` (keep-ratio + pad-32, Smooth L1 + ProbIoU aux, rotate p=0.5 ±20°) reaches **90.41% mAP50** on HRSC2016 ImageSets test (`make eval-val`, 453 images). Hub slug: `oriented_rcnn_hrsc2016_le90_3x`; eval report: [`docs/eval-reports/oriented_rcnn_hrsc2016_le90_3x/model_analysis.md`](../../docs/eval-reports/oriented_rcnn_hrsc2016_le90_3x/model_analysis.md).
